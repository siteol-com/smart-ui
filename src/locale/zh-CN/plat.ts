export default {
  ...
  'router.name': '路由名称',
  'router.name.sc': '请输入路由名称，支持模糊查询',
  'router.name.place': '请输入路由名称，全局唯一',
  'router.logInDb': '报文入库',
  'router.logInDb.tips': '打开时，请求与响应报文将存入数据库',
  ...
  'permission.static.tips': '启用后，该权限默认分配给用户',
  'permission.routers': '权限路由集',
  'permission.routers.check': '编辑权限路由集',
  'permission.del.tip': '删除权限后相关访问将被拒绝，数据无法恢复，是否确认删除改权限？'
}
