<template>
  <a-form :model="query" label-align="left" layout="vertical">
    <a-row :gutter="20">
      <a-col :span="8">
        <a-form-item field="code" :label="$t('router.url')">
      ...
      <a-col :span="8">
        <a-form-item field="type" :label="$t('router.type')">
          <a-select v-model="query.type" :options="dictList.routerType" allow-clear allow-search :placeholder="$t('button.all')" />
        </a-form-item>
      </a-col>
      <a-col :span="12">
        <a-space>
